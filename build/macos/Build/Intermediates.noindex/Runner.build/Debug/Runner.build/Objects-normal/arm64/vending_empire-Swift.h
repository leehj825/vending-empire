...
#ifndef VENDING_EMPIRE_SWIFT_H
#define VENDING_EMPIRE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="vending_empire",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14vending_empire11AppDelegate")
...
SWIFT_CLASS("_TtC14vending_empire17MainFlutterWindow")
